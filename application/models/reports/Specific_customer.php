	...
	public function getDataColumns()
	{
		return array(
			'summary' => array(
				...
				array('subtotal' => $this->lang->line('reports_subtotal'), 'sorter' => 'number_sorter', 'class' => 'currency'),
				array('tax' => $this->lang->line('reports_tax'), 'sorter' => 'number_sorter', 'class' => 'currency'),
				array('total' => $this->lang->line('reports_total'), 'sorter' => 'number_sorter', 'class' => 'currency'),
				array('cost' => $this->lang->line('reports_cost'), 'sorter' => 'number_sorter', 'class' => 'currency'),
				array('profit' => $this->lang->line('reports_profit'), 'sorter' => 'number_sorter', 'class' => 'currency'),
