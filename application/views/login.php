...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | TOKO | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
	<br>
	<br>
	<div id="logo" align="center"><img src="<?php echo base_url();?>/images/logo.png" width="300"></div>
